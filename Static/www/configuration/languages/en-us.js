window.carouselAppLanguage = {
    ...
    "premium.selectionSlide.content.sections.0.innerSlides.1.options.0.detail": "(web browsing, email, shopping, social media, streaming music and shows)",
    ...
    "premium.selectionSlide.content.sections.0.innerSlides.6.options.0.text": "LTE connectivity",
    "premium.selectionSlide.content.sections.0.innerSlides.6.options.0.detail": "(for areas with slow, no, or unsecured WiFi—requires mobile dataplan)",
    "premium.selectionSlide.content.sections.0.innerSlides.6.options.1.text": "Available in different colors and finishes",
    ...
    "devices.0.specs.3.paragraph": "Wi-Fi: Up to 10 hours of video playback*\nLTE Advanced: Up to 10 hours of battery life for local video playback*",
    ...
    "devices.1.specs.4.paragraph": "eMMC : 64 GB \nSolid-State Drive (SSD) options : 128GB, or 256 GB*",
    ...
    "devices.1.textContents.0.paragraph": "Starting at just 2.44 lbs, Surface Laptop Go lets you see and do more on a 12.45” touchscreen.",
    "devices.1.textContents.2.heading": "Sleek design and standout value",
    "devices.1.textContents.2.paragraph": "Available in signature premium materials and a choice of colors, all at an exceptional value.",
    ...
    "devices.1.textContents.3.heading": "Get it done with your favorite apps",
    "devices.1.textContents.3.paragraph": "Power through your favorite apps on the must-have everyday laptop, backed by all-day battery life.**",
    ...
    "devices.2.textContents.1.paragraph": "Built-in HD webcams backed by Studio Mics, Dolby® Audio™, and blazing-fast LTE.*",
    ...
    "devices.4.textContents.2.paragraph": "Thin and light, starting at just 3.4 lbs., with rich colors** and premium finishes.",
    "devices.4.textContents.2.disclaimer": "**Available colors may vary by store, market, and configuration.",
    ...
    "devices.6.name": "Surface Book 13.5”",
    ...
    "devices.6.textContents.2.paragraph": "Stunning color and graphics on a 13.5” PixelSense™ Display with touchscreen.",
    ...
    "devices.7.name": "Surface Book 15”",
    ...
    "devices.7.textContents.2.paragraph": "Stunning color and graphics on a 15” PixelSense™ Display with touchscreen.",
    ...
    "devices.8.textContents.2.paragraph": "Run all your favorite software, like Adobe CC,* Office 365,* and more",
